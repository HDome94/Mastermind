...
namespace eval ttk::theme::azure {
    ...
    ttk::style theme create azuredark -parent default -settings {
        ttk::style configure . \
        ...
        # Menubutton
        ttk::style configure TMenubutton -padding {3 1 3 1}
